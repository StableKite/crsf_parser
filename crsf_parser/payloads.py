...
payload_heartbeat: PayloadHeartbeatType = Struct("origin_device_address" / Int8ub)


payload_battery_sensor: PayloadBatterySensorType = Struct(
    "voltage" / Int16ub, "current" / Int16ub, "capacity" / Int24ub, "remaining" / Int8ub
)


payload_link_statistics: PayloadLinkStatisticsType = Struct(
...
payload_rc_channels_packed: PayloadRcChannelsPackedType = ByteSwapped(
